...
[![Phase](https://img.shields.io/badge/phase-0%2B1%20done-1a7f37)](docs/plan-regexp.md)
...
> **Status: Phases 0 and 1 implemented** — a greedy backtracking VM with
...
> backreferences `\1` / `\k<name>`** — differential-tested against MRI, 100%
> coverage, CI green across 6 arches. Lookaround, Unicode `\p{}`, case-folding
> and ReDoS memoization are next. See **[docs/plan-regexp.md](docs/plan-regexp.md)**
